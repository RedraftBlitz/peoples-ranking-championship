# 2026 People's Ranking Championship

This repository is the home of the 2026 People's Ranking Championship project.

## Repository contents

- [`docs/`](docs/) — product, scoring, and permanent player-identity specifications
- [`tests/`](tests/) — scoring and identity regression checks
